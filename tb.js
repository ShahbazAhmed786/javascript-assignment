// Start with the array of guests from Exercise 15
var guests = ['Ali', 'Bilal', 'Chand', 'Dawood', 'ahmed'];
...
console.log("".concat(guests[0], " and ").concat(guests[1], ", you're still invited to dinner!"));
...
guests.splice(Math.floor(guests.length / 2), 0, 'Frank');
// Use append() to add one new guest to the end of your list
guests.push('Hannah');
// Print a new set of invitation messages, one for each person in your list
console.log("\nNew Invitation Messages:");
guests.forEach(function (guest) {
    console.log("Dear ".concat(guest, ", you're invited to dinner. See you there!"));
});
