...
function doubleAndLog(num) {
    var doubled = num * 2;
    console.log("Doubled: ".concat(doubled));
}
...
function processArrayAsync(numbers) {
    return __awaiter(this, void 0, void 0, function () {
        var doubledArray;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Promise.all(numbers.map(doubleAsync))];
                case 1:
                    doubledArray = _a.sent();
                    return [2 /*return*/, doubledArray];
            }
        });
    });
}
